-- Bounds — Multi-chamber test layout
    ...
    chambers = {
...

        {
            ...
            layers = {
                {
                    ...
                    kind = "decor",
                    objects = {
                        { type="vent_round", tx = 6,  ty = 3 },
                        { type="vent",       tx = 18, ty = 5 },
                        { type="fan",        tx = 10, ty = 9 },
                        { type="panel_tall", tx = 24, ty = 12 },
                    },
                },
            ...
            objects = {
                ...
                saws = {
                    { tx = 16, ty = 4, dir = "horizontal", mount = "bottom", speed = 1.1, length = 200 },
                },
            },
        },
    }
