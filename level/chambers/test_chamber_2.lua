    ...
    layers = {
        ...
        ------------------------------------------------------
        {
            ...
            objects = {
                ...
                {type="conduit_h",          tx=15, ty=14},
                {type="conduit_h_join",     tx=16, ty=14},
                {type="conduit_h",          tx=17, ty=14},
                {type="conduit_h",          tx=18, ty=14},
                {type="conduit_h_join",     tx=19, ty=14},
                {type="conduit_h",          tx=20, ty=14},
                {type="conduit_h",          tx=21, ty=14},
				...
				{type="conduit_h_join",     tx=29, ty=14},
				{type="conduit_h",          tx=30, ty=14},
				{type="conduit_h",          tx=31, ty=14},
				{type="conduit_h_join",     tx=32, ty=14},
				{type="conduit_h",          tx=33, ty=14},
				{type="conduit_h",          tx=34, ty=14},
				{type="conduit_h_join",     tx=35, ty=14},
				{type="conduit_h",          tx=36, ty=14},
				{type="conduit_curve_bl",          tx=37, ty=14},
            }
        },
